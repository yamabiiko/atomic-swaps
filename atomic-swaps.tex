...
\pseudocode{
    ...
    \qquad lk \leftarrow \mathsf{pk_{swp}} \oplus C_1 \\
    \qquad \pi_2 \leftarrow \Pi_{\mathsf{ZK}\mathcal{L}_{\mathsf{lock}}}.\mathsf{Pr}((lk, [\mathsf{sk_{frz0}}], \mathcal{H}(\mathsf{pk_{swp}}), \pi_1, T_1), \mathsf{pk_{swp}}) \\
    \qquad \mathsf{send}(U_1, \pi_1, \pi_2, \mathcal{H}(\mathsf{pk_{swp}}), lk) \\
...
\pseudocode{
    ...
    \qquad (\pi_1, \pi_2, \mathcal{H}(\mathsf{pk_{swp}}), lk) \leftarrow \mathsf{receive}(U_0) \\
    \qquad \mathsf{\textbf{if}} \:\: \Pi_{\mathsf{ZK}\mathcal{L}_{\mathsf{lock}}}.\mathsf{Vr}((lk, [\mathsf{sk_{frz0}}], \mathcal{H}(\mathsf{pk_{swp}}), \pi_1, T_1), \pi_2) \neq 1 \\
    \qquad \quad \mathsf{\textbf{return}} \perp \\
    \qquad \Gamma_{\mathsf{Swap}}(\mathcal{H}(\mathsf{pk_{swp}}), \mathsf{sk_{init(\mathbb{B})}}(1)) \\
    ...
    \quad \sigma_{\mathsf{swp}} \gets \Pi_{\mathsf{DS}}.\mathsf{Sign}_{(\mathbb{A})}(\mathsf{sk_{frz0}} + \mathsf{sk_{frz1}}, \mathsf{tx_{rfnd}}) \\
