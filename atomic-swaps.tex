...
\pseudocode{
    ...
    %(\mathsf{sk_{frz1}}, \mathsf{pk_{frz}})_{(\mathbb{B})} \gets \mathsf{\textbf{wait}} \:\: \Gamma_{\mathsf{KeyGen}_{(\mathbb{B})}}(\mathbb{G}, [1], q) \\
    \mathsf{\textbf{select}} \:\: \{ \\
...
\pseudocode{
    ...
    %(\mathsf{sk_{frz1}}, \mathsf{pk_{frz}})_{(\mathbb{B})} \gets \mathsf{\textbf{wait}} \:\: \Gamma_{\mathsf{KeyGen}_{(\mathbb{B})}}(\mathbb{G}, [1], q) \\
    (C_0, \pi) \gets \Pi_{\mathsf{VTD}}.\mathsf{Commit}(\mathsf{sk_{frz1}}, T_0) \\
    \mathsf{send}(P_0,\: (C_0, \pi)) \\
    \mathsf{\textbf{select}} \:\: \{ \\
        \quad \mathsf{\textbf{wait}} \:\: \{ \\
            \qquad \mathsf{timeout}(T_0/2) \\
            \qquad (\mathsf{pk_{rfnd}}, \mathsf{sk_{rfnd}}) \gets \Pi_{\mathsf{DS}}.\mathsf{KeyGen}_{(\mathbb{B})}(1^\lambda) \\
            \qquad \mathsf{tx_{rfnd(\mathbb{B})}} \gets \mathsf{InitTx}_{(\mathbb{B})}(\mathsf{pk_{init}}, \mathsf{pk_{rfnd}}, \mathsf{amnt_b}) \\
            \qquad \sigma_{\mathsf{rfnd(\mathbb{B})}} \gets \Pi_{\mathsf{DS}}.\mathsf{Sign}_{(\mathbb{B})}(\mathsf{sk_{init}}, \mathsf{tx_{rfnd}}) \\
        ...
        \quad \mathsf{\textbf{wait}} \:\: \{ \\
            ...
            \qquad C_1 \leftarrow (lk \oplus \mathsf{tx_{swp(\mathbb{B})}}.\mathsf{pk_{rx}}, T_1) \\
            \qquad \mathsf{sk_{frz0}} \leftarrow \Pi_\mathsf{VTD}.\mathsf{ForceOp}(C_1) \\
