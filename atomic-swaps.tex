...
\pseudocode{
    ...
    \qquad \mathsf{send}(U_1, \pi_1, \pi_2, \mathsf{hpk}, lk) \\
...
\pseudocode{
    ...
    \qquad \mathsf{send}(U_0,\: \mathsf{pk_{init}}) \\
    \qquad (\pi_1, \pi_2, \mathsf{hpk}, lk) \leftarrow \mathsf{receive}(U_0) \\
...
\begin{pchstack}[center, boxed]
\pseudocode{
    U_0(\mathsf{tx_{swp}}) \< \< U_1(\mathsf{hpk}, \mathsf{sk_{init(\mathbb{B})}}) \\[0.1\baselineskip ][\hline] 
    \<\< \\[-0.5\baselineskip ]
