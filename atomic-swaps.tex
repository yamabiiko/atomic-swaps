...
1) When $P_1$ timeouts on $T_1$ the party should check, while $\mathsf{tx_{rfnd(\mathbb{B})}}$ is unconfirmed, if $P_0$ is publishing $\mathsf{tx_{swp(\mathbb{B})}}$ and if so retrieve $\sigma_{swp(\mathbb{A})}$ and publish $\mathsf{tx_{swp(\mathbb{A})}}$. It is also required that $\Delta > \mathbb{A}.\mathsf{ctime} + \mathbb{B}.\mathsf{ctime}$ \\
...
\pseudocode{
    ...
    \mathsf{hsig} \gets \mathsf{\textbf{wait}} \:\:  \Gamma_{\mathsf{Refund}}(\mathsf{sk_{frz1(\mathbb{B})}}, \mathsf{tx_{rfnd(\mathbb{B})}}) \\
    (C_0, \pi_0, \pi_1, \pi_2, \mathsf{lk_0} ) \gets \mathsf{\textbf{wait}} \:\: \mathsf{receive}(P_1) \\
    ...
    \mathsf{\textbf{if}} \:\: \Pi_{\mathsf{VTD}}.\mathsf{Verify}({[\mathsf{sk_{frz1(\mathbb{A})}}]}, C_0, \pi) \neq 1 \\
        \quad \mathsf{\textbf{return}} \perp \\
    \mathsf{\textbf{if}} \:\: \Pi_{\mathsf{ZK}\mathcal{L}_{\mathsf{lock}}}.\mathsf{Vr}(\mathsf{stmnt_0}, \pi_2) \neq 1 \\
        \quad \mathsf{\textbf{return}} \perp \\
    \mathsf{\textbf{select}} \:\: \{ \\
        ...
        \quad \mathsf{\textbf{wait}} \:\: \{ \\
            ...
            \qquad \mathsf{sk_{frz(\mathbb{A}b}} := \mathsf{sk_{frz0}} + \mathsf{sk_{frz1}} \\
            \qquad \mathsf{tx_{rfnd(\mathbb{A})}} \gets \mathsf{InitTx}_{(\mathbb{A})}(\mathsf{pk_{frz}}, \mathsf{pk_{init}}, \mathsf{amnt_a}) \\
            \qquad \sigma_{\mathsf{rfnd(\mathbb{A})}} \gets \Pi_{\mathsf{DS}}.\mathsf{Sign}_{(\mathbb{A})}(\mathsf{sk_{frz}}, \mathsf{tx_{rfnd}}) \\
            \qquad \mathsf{PubTx}_{(\mathbb{A})}(\sigma_{\mathsf{rfnd}}, \mathsf{tx_{rfnd}}) \\
        \quad \} \\
        \quad \mathsf{\textbf{wait}} \:\: \{ \\
            ...
            \qquad  (\mathsf{pk_{swp}}, \mathsf{sk_{swp}})_{(\mathbb{B})} \gets \Pi_{\mathsf{DS}}.\mathsf{KeyGen_{(\mathbb{B})}} \\
            ...
            \qquad \mathsf{stmnt_1} := (\mathsf{lk_1}, [\mathsf{sk_{frz0}}], \mathsf{hpk}, \pi_3, T_2) \\
            \qquad \pi_4 \gets \Pi_{\mathsf{ZK}\mathcal{L}_{\mathsf{lock}}}.\mathsf{Pr}(\mathsf{stmnt_1}, \mathsf{pk_{swp(\mathbb{B})}}) \\
...
\blockcomment{-1.4,-5}{-1.4,-1}{}
\commentline{-1.5,-3.5}{Setup}
\blockcomment{-0.93,-9.5}{-0.93,-6}{}
\commentline{-1.1,-7.5}{Timeout}
\blockcomment{-1.4,-14}{-1.4,-10}{}
\commentline{-1.5,-12}{Refund}
\blockcomment{-1.865,-24.5}{-1.865,-14.5}{}
...
\pseudocode{
    ...
    \quad \mathsf{\textbf{return}} \perp \\
    \mathsf{tx_{frz(\mathbb{B})}} \gets \:\: \mathsf{InitTx}_{(\mathbb{B})}(\mathsf{pk_{init}}, \mathsf{pk_{frz}}, \mathsf{amnt_b}) \\
    \sigma_{\mathsf{frz(\mathbb{B})}} \gets \Pi_{\mathsf{DS}}.\mathsf{Sign}_{(\mathbb{B})}(\mathsf{sk_{init}}, \mathsf{tx_{frz}}) \\
    \mathsf{PubTx}_{(\mathbb{B})}(\sigma_{\mathsf{frz}}, \mathsf{tx_{frz}}) \\
    ...
    \mathsf{hsig} := \mathcal{H}(\sigma_{\mathsf{rfnd(\mathbb{B})}}) \\
    \mathsf{stmnt_0} := (\mathsf{lk_0}, {[\mathsf{sk_{frz1(\mathbb{A})}}]}, \mathsf{hsig}, \pi_1, T_1) \\
    \pi_2 \gets \Pi_{\mathsf{ZK}\mathcal{L}_{\mathsf{lock}}}.\mathsf{Pr}(\mathsf{stmnt_0}, \sigma_{\mathsf{rfnd(\mathbb{B})}}) \\
    \mathsf{\textbf{wait}} \:\: \mathsf{send}(P_0,\: (C_0, \pi_0, \pi_1, \pi_2, \mathsf{lk_0})) \\
    \mathsf{\textbf{select}} \:\: \{ \\
        \quad \mathsf{\textbf{wait}} \:\: \{ \\
	    ...
	    \qquad (\pi_3, \pi_4, \mathsf{hpk}, \mathsf{lk_1}) \gets \mathsf{receive}(P_0) \\
            \qquad {[\mathsf{sk_{frz0(\mathbb{A})}}]} := \mathsf{pk_{frz(\mathbb{A})}} - [\mathsf{sk_{frz1(\mathbb{A})}}] \\
            \qquad \mathsf{stmnt_1} := (\mathsf{lk_1}, {[\mathsf{sk_{frz0(\mathbb{A})}}]}, \mathsf{hpk}, \pi_3, T_2) \\
            \qquad \mathsf{\textbf{if}} \:\: \Pi_{\mathsf{ZK}\mathcal{L}_{\mathsf{lock}}}.\mathsf{Vr}(\mathsf{stmnt_1}, \pi_4) \neq 1 \\
                \qquad \quad \mathsf{\textbf{return}} \perp \\
	    ...
	    \qquad C_2 := \mathsf{lk_1} \oplus \mathsf{tx_{swp(\mathbb{B})}}.\mathsf{pk_{rx}} \\
            ...
            \qquad \mathsf{sk_{frz(\mathbb{A})}} := \mathsf{sk_{frz0}} + \mathsf{sk_{frz1}} \\
            \qquad \sigma_{\mathsf{swp(\mathbb{A})}} \gets \Pi_{\mathsf{DS}}.\mathsf{Sign}_{(\mathbb{A})}(\mathsf{sk_{frz}}, \mathsf{tx_{rfnd}}) \\
            \qquad \mathsf{PubTx}_{(\mathbb{A})}(\sigma_{\mathsf{swp}}, \mathsf{tx_{swp}}) \\
        \quad \} \\
    \} \\
}
\blockcomment{-0.7,-8.5}{-0.7,-0.5}{}
\commentline{-1,-3.5}{Setup}
\blockcomment{-0.75,-11}{-0.75,-9}{}
\commentline{-1.2,-10}{Timeout}
\blockcomment{-1.2,-20}{-1.2,-11.5}{}
\commentline{-1.4,-15}{Swap}
...
Protocol version using commitment transaction with arbitrary value replacing VTD as defined by the following oracles in the blockchain interface. \\
\begin{itemize}[topsep=0pt, itemsep=0pt, leftmargin=2em]
...
$P_0$ signs and publishes a transaction transferring $\mathsf{amnt_a}$ from $\mathsf{pk_{init(\mathbb{A})}}$ to the freeze wallet $\mathsf{pk_{frz(\mathbb{A})}}$ and publishes only if both the following conditions are satisfied: \\
\begin{itemize}
\item $\Pi_{\mathsf{VTD}}.\mathsf{Verify}(\mathsf{pk_{frz}} - [\mathsf{sk_{frz0}}], C_0, \pi_0) = 1$, thus by the soundess property of the VTD scheme $P_0$ is guaranteed of retrieving the commited discrete log value $x$ in $C_0$ that satisfies $[x] =  \mathsf{pk_{frz}} - [\mathsf{sk_{frz0}}]$ after $T$ steps.  
...
\item $\Pi_{\mathsf{ZK}\mathcal{L}_{\mathsf{lock}}}.\mathsf{Vr}((\mathsf{lk_0}, \mathsf{pk_{frz(\mathbb{A})}} - [\mathsf{sk_{frz0(\mathbb{A})}}], \mathsf{hsig}, \pi_1, T_1), \pi_2) = 1$, thus we have that 
    $\exists y \:\: \text{s.t} \:\: \mathcal{H}(y) = \mathsf{hsig} \land \Pi_\mathsf{VTD}.\mathsf{Verify}(\mathsf{pk_{frz}} - [\mathsf{sk_{frz1}}], (\mathsf{lk_0} \oplus y), \pi, T_1)$, veryifing that $\sigma_\mathsf{rfnd(\mathbb{B})}$ is a valid witness for $\mathcal{L}_{\mathsf{lock}}$ and thus can be used to retrieve $C_1 := \sigma_\mathsf{rfnd(\mathbb{B})} \oplus \mathsf{lk_0}$, a commitment to a discrete log $[x]$ the same condition as above and thus we have again $[x] =  [\mathsf{sk_{frz1}}]$
\end{itemize}

The party proceeds to concurrently runs three execution paths denoted by $\textbf{wait}$, with two being refunds branch and one performing the swap. We note that from this point onwards, if any routine in the swapping branch timeouts or faults, $P_0$ will keep executing the refund branch. \\
