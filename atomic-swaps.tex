...
\pseudocode{
    ...
    \mathsf{\textbf{if}} \:\: \Pi_{\mathsf{NIZK}}.\mathsf{Verify}([\mathsf{sec}], C_1, \pi) \neq 1 \\ % verify that sec = sec_0 + sec_1 has been commited
    \quad \mathsf{\textbf{return}} \perp \\
    (C_0, \pi_0) \gets \Pi_{\mathsf{NIZK}}.\mathsf{Commit}(\mathsf{sec_0}) \\ % verify that sec_0 has been commited
    \mathsf{ctx_0} \gets \mathsf{CommitTx}_{(\mathbb{A})}(C_0, \mathsf{pk_0}, \mathsf{pk_1}, \mathsf{amnt_a}, T) \\
    ...
    \quad \} \\
    \quad \mathsf{\textbf{wait}} \:\: \{ \\
    \qquad \mathsf{send}(\mathsf{ctx_0}) \\
    ...
    \qquad \mathsf{rev_1} \gets \mathsf{\textbf{wait}} \:\: \mathsf{WatchTx}_{(\mathbb{B})}(\mathsf{RevTx_0}) \\
    \qquad \mathsf{\textbf{if}} \:\: \mathsf{rev_1} \neq 1 \\
    \qquad \quad \mathsf{\textbf{return}} \perp \\
    \quad \} \\
    \} \\
}
...
\pseudocode{
    ...
    \qquad \mathsf{receive}(\mathsf{ctx_0}) \\
    \qquad \mathsf{res_0} \gets \mathsf{\textbf{wait}} \:\: \mathsf{WatchTx}_{(\mathbb{A})}(\mathsf{ctx_0}) \\
    \qquad \mathsf{\textbf{if}} \:\: \Pi_{\mathsf{NIZK}}.\mathsf{Verify}([\mathsf{sec}]-[\mathsf{sec_1}], \mathsf{ctx_0}.C, \pi) \neq 1 \\ % verify that sec = sec_0 + sec_1 has been commited
    \qquad \quad \mathsf{\textbf{return}} \perp \\
