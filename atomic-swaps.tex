...
\pseudocode{
    ...
    (C_0, \pi) \gets \mathsf{\textbf{wait}} \:\: \mathsf{receive}(U_1) \\
    ...
    \qquad (eC, C_1, d, \pi_1) \leftarrow \Pi_\mathsf{eVTD}.\mathsf{Commit}(\mathsf{sk_{frz0}}, \mathsf{pk_{swp}}, T_1) \\
    \qquad \mathsf{send}(U_1, eC, C_1) \\
    \qquad \sigma_{\mathsf{swp(\mathbb{B})}} \gets \Gamma_{\mathsf{Swap}}(d, \mathsf{tx_{swp}}) \\
...
\pseudocode{
    ...
    \qquad (eC, C_1, \pi_1) \leftarrow \mathsf{receive}(U_0) \\
    \qquad \mathsf{\textbf{if}} \:\: \Pi_\mathsf{eVTD}.\mathsf{Verify}([\mathsf{pk_{frz}}] - [\mathsf{sk_{frz0}}], eC, C_1, \pi_1, T_1) \neq 1 \\
    \qquad \quad \mathsf{\textbf{return}} \perp \\
    \qquad \Gamma_{\mathsf{Swap}}(C, \mathsf{sk_{init(\mathbb{B})}}(1)) \\
    \qquad \mathsf{receive}(U_1) \\
    \qquad \mathsf{tx_{swp(\mathbb{B})}} \leftarrow \mathsf{GetLatestTx}_{(\mathbb{A})}(\mathsf{pk}) \\
    \qquad \mathsf{pk_{swp(\mathbb{B})}} \leftarrow \mathsf{tx_{swp(\mathbb{B})}.rx} \\
    \qquad \mathsf{sk_{frz0}} \leftarrow \Pi_\mathsf{eVTD}.\mathsf{ForceOp}(C_1, \mathsf{pk_{swp(\mathbb{B})}}) \\
    \qquad \mathsf{tx_{swp(\mathbb{A})}} \gets \mathsf{InitTx}_{(\mathbb{A})}(\mathsf{pk_{frz}}, \mathsf{pk_{swp}}, \mathsf{amnt_a}) \\
    \qquad \sigma_{\mathsf{swp}} \gets \Pi_{\mathsf{DS}}.\mathsf{Sign}_{(\mathbb{A})}(\mathsf{sk_{frz0}} + \mathsf{sk_{frz1}}, \mathsf{tx_{rfnd}}) \\
...
\begin{pchstack}[center, boxed]
\pseudocode{
    U_0(d, \mathsf{tx_{swp}}) \< \< U_1(C, \mathsf{sk_{init(\mathbb{B})}}(1)) \\[0.1\baselineskip ][\hline] 
    \<\< \\[-0.5\baselineskip ]
    \mathsf{\textbf{if}} \:\: \Pi_{\mathsf{PCom}}.\mathsf{Open}(d, \mathsf{tx_{swp}}.\mathsf{rx}, C) \neq 1 \\
    \qquad \mathsf{\textbf{return}} \perp \\
    \sigma_\mathsf{swp(\mathbb{B})} \leftarrow \Pi_{\mathsf{DS}}.\mathsf{Sign}(\mathsf{sk_{init(\mathbb{B})}}, \mathsf{tx_{swp}})
}
\end{pchstack}
