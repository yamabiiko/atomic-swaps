...
\vspace{1em}
\pseudocode{
    \mathsf{ExpiredTout}(\tout, \time) \\[0.1\baselineskip ][\hline]
    \pcif \tout \neq 0 \\
    \pcelse  \\
    \t \pcreturn 0 \\
}
...
\vspace{1em}
\pseudocode{
    \mathsf{SrcChk}(\ac, r, \mathsf{sc}, \mathcal{Z}, \tout, \expired) \\[0.1\baselineskip ][\hline]
    (\mathsf{ssk}, \mathsf{tsk}, \mathsf{rsk}) := \parse \mathsf{sks} \\
    (\mathsf{spk}, \mathsf{tpk}, \mathsf{rpk}) := \parse \mathsf{pks} \\
    (\mathsf{pks}, \mathsf{co}) := \parse \ac \\
    (\mathsf{sks}, \accd) := \parse \mathsf{sc} \\
    (a, \tout', b) := \parse \accd \\
